...
if "sk_test" in STRIPE_SECRET_KEY and not DJANGO_DEBUG and not STRIPE_TEST_OVERRIDE:
    raise ValueError("Use a valid Stripe secret key in a production environment.")
...
def start_checkout_session(customer_id, success_url, cancel_url, price_stipe_id, raw=True):
