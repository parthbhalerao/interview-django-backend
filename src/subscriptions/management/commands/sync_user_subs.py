...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser) -> None:
        ...
        parser.add_argument('--clear-dangling', action='store_true', help='Clear dangling subscriptions', default=False)
    ...
    def handle(self, *args: Any, **options: Any):
        ...
        if clear_dangling:
            ...
            print("Syncing subscriptions with group permissions...")
            ...
            if done:
                print('Done! Subscription sync completed.')
